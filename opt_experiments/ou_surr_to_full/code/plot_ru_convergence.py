...
# Output folder
dirpath_figs_conv = dirpath_base / exp_name / 'convergence_figs'
dirpath_figs_ucfit = dirpath_base / exp_name / 'uc_fit_figs'
...
for n in range(1, n_iter + 1):
    print(f'Iter: {n}')
    fpath_mask = str(dirpath_base / exp_name / 'info' / f'Ru_Rc_req_{n}_*.pkl')
    #print(fpath_mask)
